...
object PrefsHelper {
    ...
    fun getString(key: String, default: String = Prefs.DEFAULT_STRING) =
    ...
    fun getDouble(key: String, default: Double = Prefs.DEFAULT_DOUBLE) =
            prefs.getDouble(key, default)

    fun putLong(key: String, value: Long) = prefs.putLong(key, value)
    fun getLong(key: String, default: Long = Prefs.DEFAULT_LONG) = prefs.getLong(key, default)

    fun putByte(key: String, value: Byte) = prefs.putByte(key, value)
    fun getByte(key: String, default: Byte = Prefs.DEFAULT_BYTE) = prefs.getByte(key, default)

    fun putInt(key: String, value: Int) = prefs.putInt(key, value)
    fun getInt(key: String, default: Int = Prefs.DEFAULT_INT) = prefs.getInt(key, default)

    fun putBool(key: String, value: Boolean) = prefs.putBool(key, value)
    fun getBool(key: String, default: Boolean = Prefs.DEFAULT_BOOL) = prefs.getBool(key, default)

    fun <T : Any> putCollection(key: String, collection: Collection<T>, separator: String = ",") =
            prefs.putCollection(key, collection, separator)
    fun <T : Any> getCollection(key: String, separator: String = ","): Collection<T> =
            prefs.getCollection(key, separator)
